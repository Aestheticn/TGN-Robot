...
buttons = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ NIR ᴛᴏ ᴜʀ ᴄʜᴀᴛ", url="t.me/NIR_Ro_bot?startgroup=true"),
    ],
    [
    ...
    [
        ...
        InlineKeyboardButton(
            text="**NIR CHATS**", url=f"https://t.me/nir_bot_support"
        ),
    ],
    [
...
START_IMG = "https://telegra.ph/file/2eb88e08bd8b01c059f61.jpgmp4"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [NIR](t.me/aesthetic_nir) \
 Supporting isnt always financial! [ ɴᴇᴛᴡᴏʀᴋ](https://t.me/nir_bot_support) \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_video(
            START_IMG, caption= https://telegra.ph/file/2eb88e08bd8b01c059f61.jpg, NIR is Here For You❤\nI am Awake Since</code>: <code>{}</code>".format(
                uptime            
            ),
